...
litecoin = pd.read_csv('https://raw.githubusercontent.com/chrishyland/Crypto-position/master/litecoin_final.csv')
df_ltc = reverse_date(litecoin, "No")
df_ltc = scale_volume(df_ltc, 30000000)


neo = pd.read_csv('https://raw.githubusercontent.com/chrishyland/Crypto-position/master/neo_final.csv')
df_neo = reverse_date(neo, "No")
df_neo = scale_volume(df_neo, 30000000)

cardano = pd.read_csv('https://raw.githubusercontent.com/chrishyland/Crypto-position/master/cardano_final.csv')
df_car = reverse_date(cardano, "No")
df_car = scale_volume(df_car, 30000000)
